    ...
    for (const op in endpoints) {
        ...
        for (const code in operationSpec.responses) {
            ...
            if (types_1.isReferenceObject(responseObject))
                continue;
            const content = (_f = responseObject.content) !== null && _f !== void 0 ? _f : {};
        ...
        const paramTypes = (_g = opMetadata === null || opMetadata === void 0 ? void 0 : opMetadata.parameterTypes) !== null && _g !== void 0 ? _g : [];
